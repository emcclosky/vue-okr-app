       ...
       <div class="new-password-form__container">
           <div class="new-password-form__inner-container">
                ...
                <p class="new-password-form__description" v-if="submitted">
                    Your password has been successfully changed. <router-link to="/login">Log in</router-link> with your new password.
                </p>
                <div class="new-password-form__form-container" v-if="submitted === false">
                            ...
                            <div class="new-password-form__form-group">
                                <div class="new-password-form__form-item">
                                    ...
                                    <span class="new-password-form__alert" role="alert">
                                        Must contain at least eight characters, one letter, one number and one special character
                                    </span>
                                </div>
                            </div>
                            <div class="new-password-form__form-group">
                                <div class="new-password-form__form-item">
                                    ...
                                    <input
                                        ...
                                        @blur="focusAnimation($event)"
                                    >
                                    <span class="new-password-form__alert" role="alert" v-if="passwordMatch()">
...
export default {
    ...
    methods: {
        passwordMatch() {
           return this.passwordConfirmation !== this.password && this.passwordConfirmation !== '' && this.validationPassed !== true;
        },
