      ...
      <div class="profile-form__form-container">
        <form @submit.prevent="updateProfile">
          <div class="profile-form__form-item">
            ...
            >
            <span class="profile-form__alert" role="alert">Please enter a valid email</span>
          </div>
            <div class="profile-form__form-item">
              ...
              <input
                ...
                @blur="validateField($event.target)"
              >
              <span class="profile-form__alert" role="alert">First name cannot be empty.</span>
              </div>
              <div class="profile-form__form-item">
                ...
                <input
                  ...
                  @blur="validateField($event.target)"
                >
                <span class="profile-form__alert" role="alert">Last name cannot be empty.</span>
              </div>
            <div class="profile-form__button-group">
              <button class="button button--green" type="submit">Update Profile</button>
  ...
  methods: {
    ...
    async updateProfile(){
      ...
      try {
        ...
        this.$store.dispatch('setAlertNotification', {message: 'Profile updated successfully', type: 'success', visible: true});
      } catch(err) {
