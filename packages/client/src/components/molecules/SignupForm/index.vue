   ...
   <div class="signup-form component component--full-width">
       <div class="signup-form__container">
           <div class="signup-form__inner-container">
                ...
                <span class="signup-form__alert signup-form__alert--large" role="alert" v-if="generalError">An error occurred. Please try again.</span>
                        ...
                        <div>
                            <div class="signup-form__form-group">
                                <div class="signup-form__form-item">
                                    ...
                                    >
                                    <span class="signup-form__alert" role="alert">Please enter a first name.</span>
                                </div>
                                <div class="signup-form__form-item">
                                    ...
                                    <input
                                        ...
                                        @blur="validateField($event.target), focusAnimation($event)"
                                    >
                                    <span class="signup-form__alert" role="alert">Please enter a last name.</span>
                                </div>
                            </div>
                            <div class="signup-form__form-group">
                                <div class="signup-form__form-item" :class="{'invalid': duplicateError}">
                                    ...
                                    <input
                                        ...
                                        @blur="validateField($event.target), focusAnimation($event)"
                                    >
                                    <span v-if="!duplicateError" class="signup-form__alert" role="alert">Please enter a valid email</span>
                                    <span v-if="duplicateError" class="signup-form__alert" role="alert">This email is taken. Try another.</span>
                                </div>
                            </div>
                            <div class="signup-form__form-group">
                                <div class="signup-form__form-item">
                                    ...
                                    <input
                                        ...
                                        @blur="validateField($event.target), focusAnimation($event)"
                                    >
                                    <span class="signup-form__alert" role="alert">Must contain at least eight characters, one letter, one number and one special character.</span>
                                </div>
                                <div class="signup-form__form-item">
                                    ...
                                    <input
                                        ...
                                        @blur="validateField($event.target), focusAnimation($event)"
                                    >
                                    <span class="signup-form__alert" role="alert" v-if="passwordMatch()">
...
export default {
    ...
    methods: {
        passwordMatch() {
            return this.fieldsToValidate['passwd'] === true && this.registrationData.password !== this.registrationData.passwordConfirmation;
        },
        ...
        validateField(field) {
            ...
            const helpTextClassList = this.$el.querySelector('.signup-form__help-text').classList;
            let regex;
        ...
        checkFormValidation() {
            const passwordConfirm = this.$el.querySelector('#confirmPasswd').classList;
            ...
            } else if(this.registrationData.password === this.registrationData.passwordConfirmation) {
            ...
            return Object.values(this.fieldsToValidate).every(bool => bool === true);
        },
        async handleSignup() {
            if(!this.checkFormValidation()) return;
            this.registrationData.email = this.registrationData.email.toLowerCase();
            try {
                const response = await this.$store.dispatch('registerNewUser', this.registrationData);
