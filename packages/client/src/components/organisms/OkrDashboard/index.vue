            ...
            <div class="okr-dashboard__options">
                ...
                <div class="okr-dashboard__options--bottom">
                    <div class="okr-dashboard__okr-types">
                        <button type="button" @click="selectOkrType">Individual OKRs</button>
                        <button type="button" @click="selectOkrType">Corporate OKRs</button>
                        <button type="button" @click="selectOkrType">Sales Team OKRs</button>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        selectOkrType(event){
          [...this.$el.querySelectorAll('.okr-dashboard__okr-types .active')].forEach(button => {
