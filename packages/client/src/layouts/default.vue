<template>
  <div
    ...
    :class="{
      'page-container--default': !authorized,
      'page-container--logged-in': authorized,
    }"
  >
    ...
    <main id="main">
      ...
      <AlertNotification
        v-if="alertNotification.message && alertNotification.visible"
      />
      <slot />
    </main>
...
export default {
  ...
  updated() {
    if (this.routeName === "Home") {
      this.$el
        .querySelector(".home")
        .lastChild.classList.add("component--double-bottom");
    }
  },
  mounted() {
    this.scrollPos = 0;
